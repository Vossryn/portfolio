...
export default function About() {
  return (
    <div className="flex flex-col lg:flex-row flex-wrap gap-10">
      <Container className="flex flex-col w-full lg:w-1/3">
        <div
      ...
      <Container className="flex-1 lg:pl-8">
        ...
        <p>
          ...
          doloremque dolorum adipisci nam repellendus? Facere vero reprehenderit rem suscipit fugit!
          Reprehenderit iste aliquid perferendis mollitia quidem placeat!
        </p>
      </Container>
      <Container className="w-full">Info</Container>
    </div>
  );
}
